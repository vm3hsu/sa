                            ...
                            <td><a href=delete.php?BNumber=", $row['BNumber'], "&dbaction=remove>[下架此書]</a></td></tr>";
                                ...
                                <table class="table table-bordered border-warning table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $result = mysqli_query($link, $sql);
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            echo "<tr><td>", $row['name'], "</td><td>", $row['BName'], "</td><td>", $row['reason'], "</td><td><a href=delete.php?SNumber=", $row['SNumber'], "&seller=", $row['seller'], "&BNumber=", $row['BNumber'], "&dbaction=agree>[同意]</a><a href=delete.php?SNumber=", $row['SNumber'], "BNumber=", $BNumber, ">[不同意]</a></td></tr>";
                                        }
                                        ?>
                                ...
                                <table class="table table-bordered border-warning table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $link = mysqli_connect('localhost', 'root', '12345678', 'sa');
                                        session_start();
                                        $sql = "SELECT buyer, BName, name, b.BNumber FROM record r, book b, user u WHERE r.BNumber = b.BNumber AND r.reason like '' AND b.seller = " . $_SESSION['account'] . " AND u.account != " . $_SESSION['account'] . "";
