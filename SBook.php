...
<body>
    ...
    <header class="header">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <form method="post" action="SBook.php" style="border: 2px solid #4569ff;border-radius: 10px;overflow: hidden; position: relative; width: auto; height: auto; top: 30%; right: auto; bottom: auto; left: auto;">
    ...
    <tbody>
    <tr><td><b>書籍編號</b></td><td><b>書籍名稱</b></td><td><b>類別</b></td><td><b>價格</b></td></tr> 
    ...
    while ($row=mysqli_fetch_assoc($result)){
        echo "<tr><td>", $row['BNumber'], "</td><td>", $row['BName'], "</td><td>", $row['category'],
